...
#define PBM_SETTEXTCOLOR		(WM_USER+202)
#define PBM_GETTEXTCOLOR		(WM_USER+203)
#define PBM_SETTEXTBKCOLOR		(WM_USER+204)
#define PBM_GETTEXTBKCOLOR		(WM_USER+205)
#define PBM_SETSHOWPERCENT		(WM_USER+206)
#define PBM_ALIGNTEXT			(WM_USER+207)
#define PBM_SETMARQUEEOPTIONS	(WM_USER+208)
